 ...
 class BotRifma {
    ...
    public String sayReturn(String text) {
        ...
        String say = bd.firstWord[random.nextInt(bd.firstWord.length)] + bd.secondWord[random.nextInt(bd.secondWord.length)] + bd.threeWord[random.nextInt(bd.threeWord.length)] +
                bd.fourWord[random.nextInt(bd.fourWord.length)] + bd.fiveWord[random.nextInt(bd.fiveWord.length)] + "как " + bd.sixWord[random.nextInt(bd.sixWord.length)] + bd.threeWord[random.nextInt(bd.threeWord.length)]
